...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //Get topmost viewcontroller to inject dataController to the mapview controller
        ...
        if var topController = window?.rootViewController { while let presentedViewController = topController.presentedViewController  {
            ...
            let mapViewController = navigationController?.viewControllers.first as! TravelLocationsMapVC
            mapViewController.dataController = dataController
        }
        
        
//        let navigationController = window?.rootViewController as! UINavigationController
//        let mapViewController = navigationController.topViewController as! TravelLocationsMapVC
//        mapViewController.dataController = dataController
